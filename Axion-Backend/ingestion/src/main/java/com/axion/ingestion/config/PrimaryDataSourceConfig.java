...
@Configuration
@ConditionalOnProperty(prefix = "axion.datasource", name = "enabled", havingValue = "true", matchIfMissing = true)
...
public class PrimaryDataSourceConfig {
    ...
    public org.flywaydb.core.Flyway primaryFlyway(@Qualifier("primaryDataSource") DataSource primaryDataSource,
                                                 @org.springframework.beans.factory.annotation.Value("${spring.flyway.enabled:true}") boolean flywayEnabled) {
